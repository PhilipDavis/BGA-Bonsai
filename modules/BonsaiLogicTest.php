...
//    card=40&place=4,-3,1,4,4,3,1,2&table=533103075
    ...
    public function testHelperCard40()
    {
        ...
        $bonsai->meditate($cardId, $woodOrLeaf, $masterTiles, $placeTiles, $renounceGoals, $claimGoals, $discardTiles);
